...
//        isWriteStoragePermissionGranted();
        ...
        webView.loadUrl("https://keyloan.ng/login");
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_1) {
            ...
            webView.loadUrl("https://grotels.in/");
        } else if (id == R.id.nav_2) {
            webView.loadUrl("https://newsite.skygradio.com//popular_channels?type=views&sort_type=all_time");
        } else if (id == R.id.nav_3) {
            webView.loadUrl("https://newsite.skygradio.com//videos/latest?page_id=1");
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
